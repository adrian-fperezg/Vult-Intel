...
const PLATFORMS: Record<string, {
  ...
  facebook: {
    ...
    scopes: 'pages_show_list,pages_read_engagement,pages_manage_metadata,pages_read_user_content,pages_manage_ads,pages_messaging,pages_manage_posts,read_insights,public_profile',
  ...
  youtube: {
    ...
    scopes: 'https://www.googleapis.com/auth/youtube https://www.googleapis.com/auth/youtube.upload https://www.googleapis.com/auth/yt-analytics.readonly https://www.googleapis.com/auth/userinfo.profile openid',
  ...
  tiktok: {
    ...
    // Analytics also needs user.info.stats,video.list: enable them in the TikTok portal, then set TIKTOK_SCOPES.
    scopes: process.env.TIKTOK_SCOPES || 'user.info.basic,video.publish,video.upload',
